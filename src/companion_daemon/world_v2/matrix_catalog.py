...
def default_matrix_catalog() -> MatrixCatalog:
    ...
    fields = (
        ...
        _field(
            "observation.kind",
            ("text", "attachment", "receipt", "tool_result", "time_elapsed", "world_seed"),
            owner="observation",
            persistence="observation",
            confidence_required=False,
        ),
        _field(
            ...
            (
                ...
                "committed_or_settled_world_event",
                "observed_message",
                "active_plan",
                "proposal",
            ...
            confidence_required=False,
            hard_invariant_refs=("fact-truth-v1",),
        ),
        _field(
            "evidence.strength",
            ("direct", "corroborated", "plausible", "uncertain"),
            owner="deliberation",
            persistence="proposal",
        ),
        _field(
            "evidence.temporal_relation",
            ("current", "recent", "historical", "future_plan", "expired"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
        ),
        _field(
            ...
            ("cause", "constraint", "context", "consequence", "reference_only"),
            owner="deliberation",
            persistence="proposal",
        ),
        # 5.2 Life situation
        _field(
            "life.time_period",
            ("deep_night", "morning", "midday", "afternoon", "evening", "late_evening"),
            owner="logical_time",
            persistence="projection",
            confidence_required=False,
        ),
        ...
        _field(
            "life.location_visibility",
            ("private", "shareable", "public"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
            hard_invariant_refs=("privacy-v1",),
        ),
        _field(
            "life.state",
            (
        ...
        _field(
            "life.energy",
            ("restored", "steady", "strained", "depleted"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
        ),
        _field(
            "life.resource_pressure",
            ("none", "mild", "competing", "urgent"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
        ),
        ...
        _field(
            "life.social_environment",
            ("alone", "with_known_npc", "group_context", "public_ambient", "family_context"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
        ),
        _field(
            "life.scene_visibility",
            ("private", "shareable_life", "shareable_character_media", "not_shareable"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
            hard_invariant_refs=("privacy-v1",),
        ...
        _field(
            ...
            persistence="projection",
            confidence_required=False,
            expiry="character_core_revision",
            cardinality="many",
        ),
        _field(
            "drive.temporary",
        ...
        _field(
            "conflict.internal",
            (
                "care_vs_self_protection",
                "connection_vs_space",
                "plan_vs_rest",
                "honesty_vs_tact",
                "autonomy_vs_request",
                "repair_vs_withdrawal",
        ...
        _field(
            "appraisal.controllability", ("controllable", "partly_controllable", "uncontrollable")
        ),
        ...
        _field(
            "relationship.slow_variable",
            ("trust", "closeness", "respect", "reliability", "mutuality", "repair_confidence"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
            cardinality="many",
        ...
        _field(
            ...
            ("guarded", "cautious", "ordinary", "warm", "playful", "strained", "repairing"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
        ),
        ...
        _field(
            ...
            ("open", "answered", "skipped", "superseded", "cancelled", "expired"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
        ),
        _field(
            "relationship.waiting_stage",
            (
                "not_due",
                "anticipating",
                "holding_back",
        ...
        _field(
            "social_response_option",
            ("intervene", "no_intervention", "defer_intervention", "leave_open"),
            owner="deliberation",
            persistence="proposal",
        ),
        ...
        _field(
            "expression.display_strategy",
            (
                "direct",
                "brief_boundary",
                "acknowledge_then_reply",
        ...
        _field(
            "expression.language_intensity",
            ("restrained", "ordinary", "expressive", "emotionally_exposed"),
            owner="deliberation",
            persistence="proposal",
        ),
        _field(
            "expression.rhythm",
            ("immediate", "short_pause", "defer", "multi_beat", "no_reply_now"),
            owner="deliberation",
            persistence="proposal",
        ),
        _field(
            "expression.visible_action",
            (
                "reply",
                "question",
                "reaction",
        ...
        _field(
            "expression.privacy",
            ("public_safe", "personal", "intimate_non_explicit", "withhold"),
            owner="deliberation",
            persistence="proposal",
        ),
        # 5.7 Variation
        _field(
            "variation.deviation_kind",
            (
                "none",
                "rhythm_deviation",
                "plan_deviation",
        ...
        _field(
            "variation.intensity",
            ("subtle", "noticeable", "strong", "rupture_risk"),
            owner="deliberation",
            persistence="proposal",
        ),
        _field(
            "variation.behavior_form",
            (
                "linger",
                "procrastinate",
                "switch_activity",
                ...
                "seek_contact",
                "pull_away",
                "repair_spontaneously",
            ),
            owner="deliberation",
            persistence="proposal",
        ),
        _field(
            "variation.recovery_posture",
            ("self_correct", "explain_later", "repair", "hold_boundary", "let_consequence_stand"),
            owner="deliberation",
            persistence="proposal",
        ),
        _field(
            "variation.sampling_mode",
            ("baseline", "weighted_variation", "novelty_seeking", "pressure_amplified"),
            owner="deliberation",
            persistence="proposal",
        ),
        _field(
            "variation.frequency_budget",
            ("normal", "recently_varied", "cooldown_required"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
        ),
        ...
        _field(
            ...
            (
                ...
                "tool",
                "blocked_initial_auto",
            ),
            owner="acceptance",
            persistence="accepted_event",
            confidence_required=False,
            hard_invariant_refs=("capability-v1",),
        ),
        _field(
            "action.kind",
            (
            ...
            confidence_required=False,
            cardinality="many",
            hard_invariant_refs=("capability-v1", "budget-v1"),
        ),
        _field(
            "action.initial_permission",
            ("budget_auto", "preview_auto", "approval_required", "blocked"),
            owner="acceptance",
            persistence="projection",
            confidence_required=False,
            hard_invariant_refs=("capability-v1", "privacy-v1", "consent-v1"),
        ),
        _field(
            "action.settlement",
            (
                "platform_receipt",
                "platform_receipt_or_timeout",
                "external_result",
                "media_result_and_platform_receipt",
                "not_executable",
            ),
            owner="acceptance",
            persistence="external_result",
            confidence_required=False,
        ),
        _field(
            "action.state",
            ...
            persistence="projection",
            confidence_required=False,
            hard_invariant_refs=("action-terminal-state-v1",),
        ),
        # 5.9-5.11
        _field(
            "behavior.tendency",
        ...
        _field(
            ...
            persistence="projection",
            confidence_required=False,
            expiry="versioned_phase_lifecycle",
        ),
        _field(
            "action.layer",
            (
            ...
            persistence="accepted_event",
            confidence_required=False,
            hard_invariant_refs=("action-authority-v1",),
        ),
        ...
        # 5.13 persistence
        _field(
            "continuity.persistence_kind",
            (
                "transient_notice",
                "open_thread",
                "private_commitment",
                "durable_memory_candidate",
                "committed_fact_or_experience",
            ),
            owner="deliberation",
            persistence="proposal",
        ),
        ...
        _field(
            ...
            ("user_typing", "coalescing", "complete_thought", "long_narration", "new_interjection"),
            owner="observation",
            persistence="observation",
            confidence_required=False,
        ),
        _field(
            ...
            ("available", "glancing", "occupied", "deep_focus", "recovering_attention"),
            owner="projection",
            persistence="projection",
            confidence_required=False,
        ),
        _field(
            "expression.form",
            ("single_beat", "multi_beat", "reaction_then_text", "defer_with_intent", "silence"),
            owner="deliberation",
            persistence="proposal",
        ),
        _field(
        ...
        _field(
            "expression.beat_after_interjection",
            ("continue", "reconsider", "cancel", "merge", "defer"),
            owner="deliberation",
            persistence="proposal",
        ),
    )
    return MatrixCatalog(catalog_version="world-v2-matrix-2", fields=fields)
