...
def _repair_prompt(prompt: str, inspection: MediaInspection) -> str:
    return (
        ...
        "capture authorship, composition intent, privacy and scene; do not select a new photo concept."
    )
