...
OFFER_MEDIA_PATTERNS = [
    r"(自拍|照片|图片|图|表情包|生活照|随手拍|打卡照|镜子照|穿搭照|丑照|狼狈照|素颜照|抓拍)",
]

DIRECT_REQUEST_PATTERNS = [
    r"(发|给|拍|来|看看|想看|能不能|可以不可以).{0,20}(自拍|照片|图片|图|生活照|随手拍|表情包|打卡照|镜子照|穿搭照|丑照|狼狈照|素颜照|抓拍)",
    r"(自拍|照片|图片|图|生活照|随手拍|表情包|打卡照|镜子照|穿搭照|丑照|狼狈照|素颜照|抓拍).{0,12}(发|给|看看|来一张)",
