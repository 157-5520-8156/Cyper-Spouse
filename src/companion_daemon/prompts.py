...
def reply_prompt(
    ...
    state_block = (
        ...
        "- 生活状态卡只允许引用其中明确写出的事实；'安静/空档/手机不在手边/正在看消息'不能擅自细化成"
        "刷手机、发呆、在宿舍、和谁在一起等具体经历。\n"
        "- 角色背景和日常描述用于语气与气质；只有上下文的'可用知栀事实'可以支撑可验证的自我陈述。"
        "临场联想可以轻一点，但不能写成自己在某时某地做过什么、拥有过什么或认识谁的既定往事。\n"
        "- 可验证的个人事实必须有明确来源与归属：用户事实来自用户消息/记忆，知栀事实来自角色档案/生活记录；没有来源就别补写。\n"
