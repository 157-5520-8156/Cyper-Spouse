...
def reply_prompt(
    ...
    state_block = (
        ...
        "最近聊天的格式里，'你:'只代表用户说的话，'她:'只代表沈知栀自己说的话；"
        "引用旧话前必须核对说话人，绝对不要把'她:'说过的话说成'你说过/你刚刚说过/你昨晚说过'。"
        "如果是你自己先前说过，只能说'我刚才说/我昨晚说/我之前提过'，或者干脆不提是谁说的。"
        "最近聊天里的时间标签只表示本地时间新鲜度；超过一小时或隔夜的事不要说'刚刚'，"
        "隔夜只能说'昨晚/之前/那会儿'，不重要的旧话题可以默认已经结束。"
